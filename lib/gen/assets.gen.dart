...
class $AssetsImgBackgroundGen {
  ...
  /// File path: assets/img/background/OnBoardingBackground.jpg
  AssetGenImage get onBoardingBackground =>
      const AssetGenImage('assets/img/background/OnBoardingBackground.jpg');

  /// File path: assets/img/background/SplashBackground.jpg
  AssetGenImage get splashBackground =>
      const AssetGenImage('assets/img/background/SplashBackground.jpg');

  /// List of all assets
  List<AssetGenImage> get values => [onBoardingBackground, splashBackground];
}
...
class $AssetsImgIconsGen {
  ...
  /// File path: assets/img/icons/bookmarkFilled.svg
  SvgGenImage get bookmarkFilled =>
      const SvgGenImage('assets/img/icons/bookmarkFilled.svg');
  ...
  /// File path: assets/img/icons/thumsUp.svg
  SvgGenImage get thumsUp => const SvgGenImage('assets/img/icons/thumsUp.svg');
...
class $AssetsImgPostsLargeGen {
  ...
  /// File path: assets/img/posts/large/large_post_7.jpg
  AssetGenImage get largePost7 =>
      const AssetGenImage('assets/img/posts/large/large_post_7.jpg');

  /// File path: assets/img/posts/large/post_1.jpg
  AssetGenImage get post1 =>
      const AssetGenImage('assets/img/posts/large/post_1.jpg');
...
class $AssetsImgPostsSmallGen {
  ...
  /// File path: assets/img/posts/small/profile1.jpg
  AssetGenImage get profile1 =>
      const AssetGenImage('assets/img/posts/small/profile1.jpg');
  ...
  /// List of all assets
  List<AssetGenImage> get values =>
      [profile1, smallPost1, smallPost2, smallPost3, smallPost4];
}
